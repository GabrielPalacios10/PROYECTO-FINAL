...
secciones = [
    "1️⃣ ¿Qué es LaTeX?",
    "1️⃣ ¿Cómo empezar a usar LaTeX?",
    "2️⃣ Estructura del Texto",
    "3️⃣ Bibliografía y Citas",
    "4️⃣ Formato básico y listas",
    "5️⃣ Fórmulas matemáticas",
    "6️⃣ Diseño de página",
    "7️⃣ Gráficos y Diagramas"
]
...
""")
    ...
    st.title("2️⃣ Estructura del Texto en LaTeX 📜")
...
# Página: Bibliografía y Citas
    ...
    st.title("3️⃣ Bibliografía y Citas en LaTeX 📚")
...
@article{einstein1905,
  ...
  pages   = {891--921}
    ...
    st.markdown("### 2️⃣ Enlazar bibliografía en tu archivo .tex:")
    st.code(r"""
...
\end{enumerate}
    ...
    st.title("5️⃣ Fórmulas Matemáticas en LaTeX 🧮")
